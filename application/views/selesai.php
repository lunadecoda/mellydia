                           ...
                           <tbody>
                              ...
                              <tr>
								 ...
								 <td class="td-actions text-right">
									 ...
									 <?php if($aksesEdit){ ?>
								 	<button type="button" rel="tooltip" class="btn btn-warning btn-round mb-2" data-original-title="" title="" onclick="ganti(<?php echo $k->id_penjualan;?>)"><?php echo $aksesEdit->nama_akses ?></button>
								 	<?php } ?>
